...
for i in range(1, 7):
    url = f"https://www.youroutlet.pe/mochilas-escolares?page={i}"
...
excel_output = "C:/Users/geffe/Documents/SILABUZ/SARAID/lista-niños.xlsx"  # Cambia esto por la ruta donde quieres guardar el resultado
